...
public class TagsApiGenerated {
    ...
    private okhttp3.Call getTagListCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getTagListValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getTagListCall(_callback);

    }


    private ApiResponse<List<FollowedTag>> getTagListWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getTagListValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<List<FollowedTag>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getTagListAsync(final ApiCallback<List<FollowedTag>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTagListValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<List<FollowedTag>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetTagListRequestBuilder {

        private GetTagListRequestBuilder() {
        }

        /**
         * Build call for getTagList
         ...
         */
        public List<FollowedTag> execute() throws ApiException {
            ApiResponse<List<FollowedTag>> localVarResp = getTagListWithHttpInfo();
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getTagList request with HTTP info returned
         ...
         */
        public ApiResponse<List<FollowedTag>> executeWithHttpInfo() throws ApiException {
            return getTagListWithHttpInfo();
        }

        /**
         * Execute getTagList request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<FollowedTag>> _callback) throws ApiException {
            return getTagListAsync(_callback);
        }
    }
     ...
     * @return GetTagListRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> A List of followed tags </td><td>  -  </td></tr>
     ...
     */
    public GetTagListRequestBuilder getTagList() throws IllegalArgumentException {
        return new GetTagListRequestBuilder();
    }
    ...
    private ApiResponse<List<Tag>> listByPopularityWithHttpInfo(Integer page, Integer perPage) throws ApiException {
    ...
    private okhttp3.Call listByPopularityAsync(Integer page, Integer perPage, final ApiCallback<List<Tag>> _callback) throws ApiException {
    ...
    public class ListByPopularityRequestBuilder {
        ...
        public List<Tag> execute() throws ApiException {
            ApiResponse<List<Tag>> localVarResp = listByPopularityWithHttpInfo(page, perPage);
            return localVarResp.getResponseBody();
        }

 ...
 */
@ApiModel(description = "The representation of a user when accessed by themselves")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class MyUser {
  ...
  public MyUser summary(String summary) {
  ...
  **/
  ...
  public MyUser typeOf(String typeOf) {
  ...
  **/
  ...
  public MyUser twitterUsername(String twitterUsername) {
  ...
  **/
  ...
  public MyUser githubUsername(String githubUsername) {
  ...
  **/
  ...
  public MyUser websiteUrl(String websiteUrl) {
  ...
  **/
  ...
  public MyUser location(String location) {
  ...
  **/
  ...
  public MyUser joinedAt(String joinedAt) {
  ...
  **/
  ...
  public MyUser profileImage(String profileImage) {
  ...
  **/
  ...
  public MyUser badgeIds(List<Integer> badgeIds) {
  ...
  public MyUser addBadgeIdsItem(Integer badgeIdsItem) {
  ...
  **/
  ...
  public MyUser followersCount(Integer followersCount) {
  ...
  **/
   ...
   * @return the MyUser instance itself
   */
  public MyUser putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.summary, myUser.summary) &&
        Objects.equals(this.typeOf, myUser.typeOf) &&
        Objects.equals(this.id, myUser.id) &&
        Objects.equals(this.username, myUser.username) &&
        Objects.equals(this.name, myUser.name) &&
        Objects.equals(this.twitterUsername, myUser.twitterUsername) &&
        Objects.equals(this.githubUsername, myUser.githubUsername) &&
        Objects.equals(this.email, myUser.email) &&
        Objects.equals(this.websiteUrl, myUser.websiteUrl) &&
        Objects.equals(this.location, myUser.location) &&
        Objects.equals(this.joinedAt, myUser.joinedAt) &&
        Objects.equals(this.profileImage, myUser.profileImage) &&
        Objects.equals(this.badgeIds, myUser.badgeIds) &&
        Objects.equals(this.followersCount, myUser.followersCount)&&
        Objects.equals(this.additionalProperties, myUser.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(summary, typeOf, id, username, name, twitterUsername, githubUsername, email, websiteUrl, location, joinedAt, profileImage, badgeIds, followersCount, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MyUser
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MyUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MyUser is not found in the empty JSON string", MyUser.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MyUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MyUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MyUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MyUser.class));

       return (TypeAdapter<T>) new TypeAdapter<MyUser>() {
           @Override
           public void write(JsonWriter out, MyUser value) throws IOException {
           ...
           @Override
           public MyUser read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MyUser instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MyUser given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MyUser
  * @throws IOException if the JSON string is invalid with respect to MyUser
  */
  public static MyUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MyUser.class);
  }

 /**
  * Convert an instance of MyUser to an JSON string
  *
  * @return JSON string
  */

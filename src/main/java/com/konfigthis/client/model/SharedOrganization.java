 ...
 */
@ApiModel(description = "The organization the resource belongs to")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class SharedOrganization {
  ...
  **/
   ...
   * @return the SharedOrganization instance itself
   */
  public SharedOrganization putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, sharedOrganization.name) &&
        ...
        Objects.equals(this.additionalProperties, sharedOrganization.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, username, slug, profileImage, profileImage90, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SharedOrganization
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SharedOrganization.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SharedOrganization>() {
           ...
           public SharedOrganization read(JsonReader in) throws IOException {
             ...
             SharedOrganization instance = thisAdapter.fromJsonTree(jsonObj);

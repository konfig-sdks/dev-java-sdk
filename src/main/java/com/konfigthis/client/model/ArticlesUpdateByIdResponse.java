...
import com.konfigthis.client.model.ArticlesUpdateByIdResponseUser;
...
public class ArticlesUpdateByIdResponse {
  ...
  private ArticlesUpdateByIdResponseUser user;

  public ArticlesUpdateByIdResponse() {
  }

  public ArticlesUpdateByIdResponse tags(List<String> tags) {
  ...
  public ArticlesUpdateByIdResponse addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public ArticlesUpdateByIdResponse title(String title) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Recalled to Life9", value = "")
  ...
  public ArticlesUpdateByIdResponse description(String description) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Messenger bag kickstarter fingerstache. Green juice hammock taxidermy.  Gastropub pop-up godard put a...", value = "")
  ...
  public ArticlesUpdateByIdResponse typeOf(String typeOf) {
  ...
  **/
  ...
  public ArticlesUpdateByIdResponse id(Double id) {
  ...
  public ArticlesUpdateByIdResponse id(Integer id) {
  ...
  **/
  ...
  public ArticlesUpdateByIdResponse readablePublishDate(String readablePublishDate) {
  ...
  **/
  ...
  public ArticlesUpdateByIdResponse slug(String slug) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "recalled-to-life9-1990", value = "")
  ...
  public ArticlesUpdateByIdResponse path(String path) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "/username11/recalled-to-life9-1990", value = "")
  ...
  public ArticlesUpdateByIdResponse url(String url) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "http://forem.test/username11/recalled-to-life9-1990", value = "")
  ...
  public ArticlesUpdateByIdResponse commentsCount(Double commentsCount) {
  ...
  public ArticlesUpdateByIdResponse commentsCount(Integer commentsCount) {
  ...
  **/
  ...
  public ArticlesUpdateByIdResponse publicReactionsCount(Double publicReactionsCount) {
  ...
  public ArticlesUpdateByIdResponse publicReactionsCount(Integer publicReactionsCount) {
  ...
  **/
  ...
  public ArticlesUpdateByIdResponse collectionId(String collectionId) {
  ...
  **/
  ...
  public ArticlesUpdateByIdResponse publishedTimestamp(String publishedTimestamp) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2023-12-15T00:15:28Z", value = "")
  ...
  public ArticlesUpdateByIdResponse positiveReactionsCount(Double positiveReactionsCount) {
  ...
  public ArticlesUpdateByIdResponse positiveReactionsCount(Integer positiveReactionsCount) {
  ...
  **/
  ...
  public ArticlesUpdateByIdResponse coverImage(String coverImage) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "http://forem.test/assets/21-8c16e6ef44da175a1e51f1ba9d0cb55af8a920db6aacbf1e4b7a055afc1b3d30.png", value = "")
  ...
  public ArticlesUpdateByIdResponse socialImage(String socialImage) {
  ...
  **/
  ...
  public ArticlesUpdateByIdResponse canonicalUrl(String canonicalUrl) {
  ...
  **/
  ...
  public ArticlesUpdateByIdResponse createdAt(String createdAt) {
  ...
  **/
  ...
  public ArticlesUpdateByIdResponse editedAt(String editedAt) {
  ...
  **/
  ...
  public ArticlesUpdateByIdResponse crosspostedAt(String crosspostedAt) {
  ...
  **/
  ...
  public ArticlesUpdateByIdResponse publishedAt(String publishedAt) {
  ...
  **/
  ...
  public ArticlesUpdateByIdResponse lastCommentAt(String lastCommentAt) {
  ...
  **/
  ...
  public ArticlesUpdateByIdResponse readingTimeMinutes(Double readingTimeMinutes) {
  ...
  public ArticlesUpdateByIdResponse readingTimeMinutes(Integer readingTimeMinutes) {
  ...
  **/
  ...
  public ArticlesUpdateByIdResponse tagList(String tagList) {
  ...
  **/
  ...
  public ArticlesUpdateByIdResponse bodyHtml(String bodyHtml) {
  ...
  **/
  ...
  public ArticlesUpdateByIdResponse bodyMarkdown(String bodyMarkdown) {
  ...
  **/
  ...
  public ArticlesUpdateByIdResponse user(ArticlesUpdateByIdResponseUser user) {
  ...
  **/
  ...
  public ArticlesUpdateByIdResponseUser getUser() {
    return user;
  }


  public void setUser(ArticlesUpdateByIdResponseUser user) {
   ...
   * @return the ArticlesUpdateByIdResponse instance itself
   */
  public ArticlesUpdateByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ArticlesUpdateByIdResponse articlesUpdateByIdResponse = (ArticlesUpdateByIdResponse) o;
    return Objects.equals(this.tags, articlesUpdateByIdResponse.tags) &&
        Objects.equals(this.title, articlesUpdateByIdResponse.title) &&
        Objects.equals(this.description, articlesUpdateByIdResponse.description) &&
        Objects.equals(this.typeOf, articlesUpdateByIdResponse.typeOf) &&
        Objects.equals(this.id, articlesUpdateByIdResponse.id) &&
        Objects.equals(this.readablePublishDate, articlesUpdateByIdResponse.readablePublishDate) &&
        Objects.equals(this.slug, articlesUpdateByIdResponse.slug) &&
        Objects.equals(this.path, articlesUpdateByIdResponse.path) &&
        Objects.equals(this.url, articlesUpdateByIdResponse.url) &&
        Objects.equals(this.commentsCount, articlesUpdateByIdResponse.commentsCount) &&
        Objects.equals(this.publicReactionsCount, articlesUpdateByIdResponse.publicReactionsCount) &&
        Objects.equals(this.collectionId, articlesUpdateByIdResponse.collectionId) &&
        Objects.equals(this.publishedTimestamp, articlesUpdateByIdResponse.publishedTimestamp) &&
        Objects.equals(this.positiveReactionsCount, articlesUpdateByIdResponse.positiveReactionsCount) &&
        Objects.equals(this.coverImage, articlesUpdateByIdResponse.coverImage) &&
        Objects.equals(this.socialImage, articlesUpdateByIdResponse.socialImage) &&
        Objects.equals(this.canonicalUrl, articlesUpdateByIdResponse.canonicalUrl) &&
        Objects.equals(this.createdAt, articlesUpdateByIdResponse.createdAt) &&
        Objects.equals(this.editedAt, articlesUpdateByIdResponse.editedAt) &&
        Objects.equals(this.crosspostedAt, articlesUpdateByIdResponse.crosspostedAt) &&
        Objects.equals(this.publishedAt, articlesUpdateByIdResponse.publishedAt) &&
        Objects.equals(this.lastCommentAt, articlesUpdateByIdResponse.lastCommentAt) &&
        Objects.equals(this.readingTimeMinutes, articlesUpdateByIdResponse.readingTimeMinutes) &&
        Objects.equals(this.tagList, articlesUpdateByIdResponse.tagList) &&
        Objects.equals(this.bodyHtml, articlesUpdateByIdResponse.bodyHtml) &&
        Objects.equals(this.bodyMarkdown, articlesUpdateByIdResponse.bodyMarkdown) &&
        Objects.equals(this.user, articlesUpdateByIdResponse.user)&&
        Objects.equals(this.additionalProperties, articlesUpdateByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ArticlesUpdateByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ArticlesUpdateByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ArticlesUpdateByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ArticlesUpdateByIdResponse is not found in the empty JSON string", ArticlesUpdateByIdResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("collection_id").isJsonNull() && (jsonObj.get("collection_id") != null && !jsonObj.get("collection_id").isJsonNull()) && !jsonObj.get("collection_id").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("edited_at") != null && !jsonObj.get("edited_at").isJsonNull()) && !jsonObj.get("edited_at").isJsonPrimitive()) {
      ...
      if (jsonObj.get("user") != null && !jsonObj.get("user").isJsonNull()) {
        ArticlesUpdateByIdResponseUser.validateJsonObject(jsonObj.getAsJsonObject("user"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ArticlesUpdateByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ArticlesUpdateByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ArticlesUpdateByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ArticlesUpdateByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ArticlesUpdateByIdResponse>() {
           @Override
           public void write(JsonWriter out, ArticlesUpdateByIdResponse value) throws IOException {
           ...
           @Override
           public ArticlesUpdateByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ArticlesUpdateByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ArticlesUpdateByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ArticlesUpdateByIdResponse
  * @throws IOException if the JSON string is invalid with respect to ArticlesUpdateByIdResponse
  */
  public static ArticlesUpdateByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ArticlesUpdateByIdResponse.class);
  }

 /**
  * Convert an instance of ArticlesUpdateByIdResponse to an JSON string
  *
  * @return JSON string
  */

 ...
 */
@ApiModel(description = "Representation of an Article to be created/updated")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Article {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(article, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Article.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("article") != null && !jsonObj.get("article").isJsonNull()) {
        ArticleArticle.validateJsonObject(jsonObj.getAsJsonObject("article"));
      }
  }
